...
def lambda_handler(event, context):
    ...
    message  = 'Downloaded the file from {} as {}, uploaded it to the S3 bucket {}, and re-downloaded it'.format(yyyy_mm, file, s3_bucket_name)
    return { 
        'Success: ' : message
    }
